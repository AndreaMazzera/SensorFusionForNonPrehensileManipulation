    ...
    private:
        ...
        void modelStatesCallback(const gazebo_msgs::msg::ModelStates::SharedPtr msg)
        {
            ...
            if (z < 0.5 && abs(ee_pose[3]) < 0.2 && abs(ee_pose[4]) < 0.2 && abs(ee_vel[0]) < 0.01 && abs(ee_vel[1]) < 0.01) 
            {
                ...
                std::string spawn_command = "gz model --spawn-file=/home/andrea/noprehensileman_ws/src/iiwa_description/models/cuboid_object/model.sdf ";
                ...
                spawn_command += " -R " + std::to_string(0.0);
                spawn_command += " -P " + std::to_string(0.0);
                spawn_command += " -Y " + std::to_string(0.0);
