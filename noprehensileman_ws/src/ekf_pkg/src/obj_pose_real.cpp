...
class RealObjPosePublisher : public rclcpp::Node
{
    public:
        ...
        {
            // Initialize vector of tray pose
            ee_pose.resize(6);
            ...
            // Publisher real pose of object respect to (center) tray
            ...
            // Timer to periodically check for the transform and publish the point
    ...
    private:
        ...
        void modelStatesCallback(const gazebo_msgs::msg::ModelStates::SharedPtr msg)
        {
            ...
            obj_worldpose[2] = roll;  // Store the yaw angle
        ...
        void publish_transform ()
        {
            ...
            double yaw_cuboid_rad = obj_worldpose[2] - 3.14; 
