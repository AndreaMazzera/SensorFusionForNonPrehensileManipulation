...
class Monitor : public rclcpp::Node 
{
    ...
    private:
        ...
        rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr control_torques_subscriber;
